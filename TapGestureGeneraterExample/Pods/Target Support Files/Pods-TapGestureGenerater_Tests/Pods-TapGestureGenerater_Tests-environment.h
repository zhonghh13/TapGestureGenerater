...
// TapGestureGenerater
#define COCOAPODS_POD_AVAILABLE_TapGestureGenerater
#define COCOAPODS_VERSION_MAJOR_TapGestureGenerater 0
#define COCOAPODS_VERSION_MINOR_TapGestureGenerater 1
#define COCOAPODS_VERSION_PATCH_TapGestureGenerater 0
